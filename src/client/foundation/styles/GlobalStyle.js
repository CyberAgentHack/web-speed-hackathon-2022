...
export const GlobalStyle = createGlobalStyle`
 ${resetCss}
  ...
  @font-face {
    ...
    url("/assets/fonts/MODI_Senobi-Gothic_2017_0702/Senobi-Gothic-Bold-Subset-Numbers.woff") format("woff"),
    url("/assets/fonts/MODI_Senobi-Gothic_2017_0702/Senobi-Gothic-Bold-Subset-Numbers.ttf") format("truetype");
  }
`;
